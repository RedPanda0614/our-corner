...
const SHELL = ['./', 'index.html', 'style.css', 'app.css', 'config.js', 'calendar-import.js', 'store.js', 'bgm.js', 'app.js',
  'manifest.webmanifest', 'assets/hero.jpg', 'assets/bunny.png', 'assets/fusion-pixel-sc.woff2', 'assets/icon-192.png'];
